...
describe("parameters auto-validation", function () {
    var UserFilter = /** @class */ (function () {
        ...
        ], UserFilter.prototype, "keyword", void 0);
        return UserFilter;
    }());
    ...
    describe("should apply global validation enable", function () {
        var requestFilter;
        beforeEach(function () {
    ...
    describe("should apply local validation enable", function () {
        var requestFilter;
        beforeEach(function () {
            requestFilter = undefined;
        });
        before(function () {
            ...
            var ClassTransformUserController = /** @class */ (function () {
                ...
                __decorate([
                    ...
                    __param(0, QueryParam_1.QueryParam("filter", { validate: true })),
                    __metadata("design:type", Function),
                    __metadata("design:paramtypes", [UserFilter]),
                    __metadata("design:returntype", Object)
                ], ClassTransformUserController.prototype, "getUsers", null);
    ...
    describe("should apply global validation options", function () {
        var requestFilter;
        beforeEach(function () {
            requestFilter = undefined;
        });
        ...
        before(function (done) { return koaApp = index_1.createKoaServer(options).listen(3002, done); });
        after(function (done) { return koaApp.close(done); });
        test_utils_1.assertRequest([3001, 3002], "get", "user?filter={\"notKeyword\": \"Um\", \"__somethingPrivate\": \"blablabla\"}", function (response) {
            expect(response).to.have.status(200);
            expect(requestFilter).to.have.property("notKeyword");
        });
    });
    describe("should pass the valid param after validation", function () {
        var requestFilter;
        beforeEach(function () {
            requestFilter = undefined;
        });
        ...
        before(function (done) { return koaApp = index_1.createKoaServer(options).listen(3002, done); });
        after(function (done) { return koaApp.close(done); });
        test_utils_1.assertRequest([3001, 3002], "get", "user?filter={\"keyword\": \"Umedi\", \"__somethingPrivate\": \"blablabla\"}", function (response) {
            expect(response).to.have.status(200);
    ...
    describe("should contain param name on validation failed", function () {
        var requestFilter;
        beforeEach(function () {
            requestFilter = undefined;
        });
        ...
        test_utils_1.assertRequest([3001, 3002], "get", "user?filter=" + JSON.stringify(invalidFilter), function (response) {
            expect(response).to.have.status(400);
            expect(response.body.paramName).to.equal("filter");
        });
    });
});
//# sourceMappingURL=class-validator-options.spec.js.map